class MA_SPI_Helmet; // MA_Armor
class 34thPRC_ArmourStandard_SPI_Helmet_Gold : MA_SPI_Helmet
{
	displayName="[34th] SPI MK III Helmet[VISR 1.0]";
	author= "Vazya";
...
{
	displayName="[34th] SPI MK III Helmet[VISR 1.5]";
	author= "Vazya";
	hiddenSelectionsTextures[]=
	{
		"\z\34thprc\addons\armour_standard\data\spi\34_SPI_Helmet.paa",
...
class 34thPRC_ArmourStandard_SPI_Armor: MA_SPI_Armor
{
	displayName="[34th] SPI MK III Armor";
	author= "Vazya";
	hiddenSelectionsTextures[]=
	{
