class 34thPRC_ArmouStandard_Pilot_IHADSS_Helmet_Arctic : 34thPRC_ArmouStandard_Pilot_IHADSS_Helmet_Urban
{
	author="Over Yandere";
	displayName="[34th] IHADSS Helmet (Arctic)";
	hiddenSelectionsTextures[]=
	{
		"\z\34thprc\addons\armour_standard\data\pilot\pilot_helmet_addons.paa",
		"\z\34thprc\addons\armour_standard\data\pilot\arctic\pilot_helmet_ext.paa",
